...
var glixl = (function(glixl)
{
    ...
    glixl.initialise = function(app)
    {
        ...
        glixl.mouse_x = 0;
        glixl.mouse_y = 0;
        glixl.mouse_down = false;
        
        window.addEventListener("mousemove", glixl.save_mouse_position);
        glixl.canvas.addEventListener("mousedown", glixl.handle_mouse_down, false);
        glixl.canvas.addEventListener("mouseup", glixl.handle_mouse_up, false);
        glixl.canvas.addEventListener("touchstart", glixl.handle_mouse_down, false);
        glixl.canvas.addEventListener("touchend", glixl.handle_mouse_up, false);
    ...
    glixl.TileMap.prototype.find_path = function(start_position, end_position, depth, inverted) 
    {
        if (typeof inverted == 'undefined') { inverted = false; } // Currently unimplemented.
    ...
    glixl.handle_mouse_down = function(e)
    {
        glixl.save_mouse_position(e);
        glixl.mouse_down = true;
    }
    
    glixl.handle_mouse_up = function(e)
    {
        glixl.save_mouse_position(e);
        glixl.mouse_down = false;
    }
